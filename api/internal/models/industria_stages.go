...
// libera "Finalizar Máquina". Hoje é Finalização (o teste na Câmara de Teste
// acontece antes, mas quem fecha o ciclo é essa etapa).
const StageFinal = StageFinalizacao

// StageOrder lista os 5 processos na ordem de fabricação. StageFinal fica por
// último.
var StageOrder = []string{StageEletrica, StageSoldagem, StageMontagem, StageCamaraDeTeste, StageFinalizacao}
