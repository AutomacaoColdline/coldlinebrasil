...
func main() {
	...
	api := r.Group("/api")
	{
		...
		prod.GET("/builds/:buildId/serials", productionHandler.GetSerials)
		prod.POST("/builds/:buildId/serials", productionHandler.CreateSerial)
		prod.PUT("/serials/:id", productionHandler.UpdateSerial)
		prod.DELETE("/serials/:id", productionHandler.DeleteSerial)
