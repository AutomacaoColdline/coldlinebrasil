  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-center gap-3 mt-6">
        <button
          onClick={() => goTo(idx - 1)}
          className="w-8 h-8 rounded-full border border-gray-200 hover:border-brand-mid flex items-center justify-center text-gray-400 hover:text-brand-mid transition-colors"
          aria-label="Anterior"
        >
          <ChevronLeft size={16} />
        </button>
          ...
          {products.map((_, i) => (
            <button
              ...
              style={{
                ...
                backgroundColor: i === idx ? '#1E5FAF' : '#d1d5db',
              }}
            />
          ))}
        </div>
